...
from tests.api.managers.api_test_templates import request_execute_payload, request_execute_status, request_execute_error
...
def test_req_handler_system_check_update(f_validator, f_api_manager: ApiManager, f_network: DummyNetworkManager,
    ...
    request_execute_payload(ApiURIs.bridge_update_check.uri,
...
def test_req_handler_system_check_update_not_available(f_validator, f_api_manager: ApiManager,
    ...
    request_execute_status(ApiURIs.bridge_update_check.uri,
                           {},
                           f_network,
                           f_credentials,
                           f_validator)
...
def test_req_handler_system_check_update_validation_error(f_validator, f_api_manager: ApiManager,
                                                          f_network: DummyNetworkManager,
                                                          f_credentials, f_update_manager):
    request_execute_error(ApiURIs.bridge_update_check.uri,
                          "ValidationError",
                          {"yolo": 123},
                          f_network,
                          f_credentials,
