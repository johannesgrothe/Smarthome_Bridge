...
def test_req_handler_clients_client_config_delete(f_validator, f_api_manager: ApiManager,
                                                  f_network: DummyNetworkManager,
                                                  f_credentials, f_client):
    request_execute_status(ApiURIs.client_config_delete.uri,
                           {"id": f_client.id},
                           f_network,
                           f_credentials,
                           f_validator)
...
def test_req_handler_clients_client_config_delete_validation_error(f_validator, f_api_manager: ApiManager,
                                                                   f_network: DummyNetworkManager,
                                                                   f_credentials, f_client):
...
def test_req_handler_clients_client_config_delete_unknown_client(f_validator, f_api_manager: ApiManager,
...
def test_req_handler_clients_client_reboot_failed(f_validator, f_api_manager: ApiManager,
