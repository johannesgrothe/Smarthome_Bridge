...
PATH_CLIENT_SYSTEM_CONFIG_WRITE = "config/gadgets/write"
PATH_CLIENT_EVENT_CONFIG_WRITE = "config/events/write"
PATH_CLIENT_GADGET_CONFIG_WRITE = "config/system/write"
